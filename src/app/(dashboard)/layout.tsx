...
export default function DashboardLayout({
    ...
    if (shouldRedirectToDashboard) {
        return <div className="flex min-h-[100dvh] bg-white dark:bg-background" />;
    }

    return (
        <div className="flex h-[calc(100dvh-var(--safe-top)-var(--safe-bottom)+12px)] -mt-[calc(var(--safe-top)-12px)] bg-white dark:bg-background overflow-hidden font-sans">
            <AuthSessionGuard />
            ...
            <div className="flex-1 min-h-0 flex flex-col overflow-hidden relative w-full z-10">
                ...
                <div
                    aria-hidden="true"
                    className="h-[calc(5.75rem+var(--safe-bottom))] shrink-0 md:hidden"
                />
